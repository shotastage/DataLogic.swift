...
public struct RandStr {
    ...
    public private(set) var idString: String
    ...
    public init(length: Int) {
        idString = RandStr.generateRandomString(length: length, conditions: [.alphabetic, .numeric])!
    }
    ...
    public init(length: Int, conditions: [TextConditions]) {
        idString = RandStr.generateRandomString(length: length, conditions: conditions)!
    }
